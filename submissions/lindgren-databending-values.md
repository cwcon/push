...
level description of this snippet of source code. As De Millo _et al_ note in the epigraph, a 
small change in a complex system, even a "bit," can instigate adverse effects, which a traditional 
programmer will locate and remove from the program, if possible. Yet, for a glitch artist, such 
mistakes become the exigencies and materials for glitch art production.
...
perhaps, due to its inclusive approch to source code and initial simplicity, inviting end users to 
